...
// function from a Genkit action. It automatically implements
// streaming if your flow does.
...
// access to these sensitive values can be controlled. defineSecret
...
// traces, and logs to Google Cloud
// Observability. See
...
export const menuSuggestion = onCallGenkit({
  ...
  // request data. The isSignedIn() and hasClaim() helpers can be used
